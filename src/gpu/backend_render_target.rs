...
pub fn skia_backend_render_target_is_valid(_ptr: *mut ValueBox<BackendRenderTarget>) -> bool {
    _ptr.with_not_null_return(false, |backend_render_target| backend_render_target.is_valid())
}

#[no_mangle]
pub fn skia_backend_render_target_is_protected(_ptr: *mut ValueBox<BackendRenderTarget>) -> bool {
    _ptr.with_not_null_return(false, |backend_render_target| backend_render_target.is_protected())
}
