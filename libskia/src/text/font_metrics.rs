...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_default() -> OwnedPtr<FontMetrics> {
    OwnedPtr::new(FontMetrics::default())
}

#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_top(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics.with_ref_ok(|metrics| metrics.top).or_log(0.0)
}

#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_ascent(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_descent(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_bottom(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_leading(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_x_min(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_x_max(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_metrics_get_x_height(font_metrics: BorrowedPtr<FontMetrics>) -> scalar {
    font_metrics
