...
pub extern "C" fn skia_font_style_get_count(
    mut font_style_set: BorrowedPtr<FontStyleSet>,
) -> usize {
    font_style_set.with_mut_ok(|set| set.count()).or_log(0)
}

#[unsafe(no_mangle)]
pub extern "C" fn skia_font_style_set_count(font_style_set: BorrowedPtr<FontStyleSet>) -> usize {
    skia_font_style_get_count(font_style_set)
}
...
pub extern "C" fn skia_font_style_set_style_at(
    font_style_set: BorrowedPtr<FontStyleSet>,
    index: usize,
) -> OwnedPtr<FontStyle> {
    skia_font_style_get_style_at(font_style_set, index)
}
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_font_style_set_drop(font_style_set: OwnedPtr<FontStyleSet>) {
    drop(font_style_set);
}
