...
#[unsafe(no_mangle)]
pub extern "C" fn skia_surface_props_default() -> OwnedPtr<SurfaceProps> {
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_surface_props_get_pixel_geometry(
...
#[unsafe(no_mangle)]
pub extern "C" fn skia_surface_props_get_flags(surface_props: BorrowedPtr<SurfaceProps>) -> u32 {
    surface_props
